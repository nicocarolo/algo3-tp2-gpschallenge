...
public class CambioDeVehiculoTest {
	...
	@Test
	public void testDeberiaCambiarDeAutoACamioneta() throws ExcepcionEsquinaInvalida, ExcepcionJuegoTerminado, ExcepcionJugadorYaAsignadoAlVehiculo {
	...
	@Test
	public void testDeberiaCambiarDeMotoAAuto() throws ExcepcionEsquinaInvalida, ExcepcionJuegoTerminado, ExcepcionJugadorYaAsignadoAlVehiculo {
		Mapa unMapa = new Mapa(12, 12);
	...
	@Test
	public void testDeberiaCambiarDeCamionetaAMoto() throws ExcepcionEsquinaInvalida, ExcepcionJuegoTerminado, ExcepcionJugadorYaAsignadoAlVehiculo {
		Mapa unMapa = new Mapa(12, 12);
