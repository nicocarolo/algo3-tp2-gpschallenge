...
public class JuegoFacilTest {
	...
	@Test
	public void testJuegoFacilDeberiaTener1DeCadaSorpresaYObstaculo()
			throws ExcepcionEsquinaInvalida,
			ExcepcionJugadorYaAsignadoAlVehiculo {
		JuegoFacil unJuegoFacil = new JuegoFacil("Ezequiel", 3, new Posicion(3,
				3), new Auto(new Esquina(new Posicion(3, 3))));
