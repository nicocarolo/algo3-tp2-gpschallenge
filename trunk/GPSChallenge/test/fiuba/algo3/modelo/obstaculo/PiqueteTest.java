...
public class PiqueteTest {
	...
	@Test
	public void testDeberiaCambiarleLaDireccionAlAuto() throws ExcepcionEsquinaInvalida {
	...
	@Test
	public void testDeberiaCambiarleLaDireccionALaCamioneta() throws ExcepcionEsquinaInvalida {
		Mapa unMapa = new Mapa(20, 20);
	...
	@Test
	public void testNoDeberiaCambiarleLaDireccionALaMoto() throws ExcepcionEsquinaInvalida {
		Mapa unMapa = new Mapa(20, 20);
	...
	@Test
	public void testDeberiaAumentarleLosMovimientosALaMoto() throws ExcepcionEsquinaInvalida {
		Mapa unMapa = new Mapa(20, 20);
		Moto unaMoto = new Moto(unMapa);
		Jugador unJugador = new Jugador(unaMoto);
		Piquete unPiquete = new Piquete(unaMoto.devolverEsquina());
