...
//		
		auto = new JButton("");
		auto.setIcon(new ImageIcon(getClass().getResource("/fiuba/algo3/vista/imagenes/car.jpg")));
		auto.setBackground(new Color(0, 0, 139));
		auto.setBounds(posX, posY, 44, 23);
		add(auto);
	...
	public void paintComponent (Graphics g){
		...
		this.bgImage = new ImageIcon(getClass().getResource("/fiuba/algo3/vista/imagenes/mapa.jpg"));
