...
public class AcercaDeFrame extends JFrame {
	...
	public AcercaDeFrame(){
		...
		lblGpsChallenge.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 15));
		...
		JLabel lbldesarrolladoPorHernan = new JLabel("-Desarrollado por: Hernan Arroyo, Nicolas Carolo, Ezequiel Grillo,");
		...
		JLabel lblcontatenosSugerenciasgpschallengecom = new JLabel("-Contatenos: sugerencias@gpschallenge.com");
